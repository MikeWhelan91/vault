        ...
        <Card>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-900 dark:text-white">{bundleName}</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1">
                {selectedItems.map((itemId) => {
                  ...
                  return item ? (
                    <li key={itemId} className="text-gray-900 dark:text-white">
            ...
            <div>
              ...
              <ul className="space-y-1">
                {trustees.map((trustee) => (
                  <li key={trustee.id} className="text-gray-900 dark:text-white">
                    {trustee.name || trustee.email}
                  </li>
                ))}
              </ul>
