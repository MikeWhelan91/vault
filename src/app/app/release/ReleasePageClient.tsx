        ...
        <Card className="bg-orange-50 border-orange-200">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-lg font-semibold text-plum-900 mb-2">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <button
                  ...
                  `}
                >
                  <Calendar className={`w-8 h-8 mb-3 ${mode === 'time-lock' ? 'text-primary-600' : 'text-warm-400'}`} />
                  <h3 className="font-semibold text-plum-900 mb-1">
                    Scheduled Date
                  </h3>
                ...
                <button
                  ...
                  `}
                >
                  <Heart className={`w-8 h-8 mb-3 ${mode === 'heartbeat' ? 'text-primary-600' : 'text-warm-400'}`} />
                  <h3 className="font-semibold text-plum-900 mb-1">
      ...
      {canCreate && step === 2 && (
        <Card>
          ...
          {metadata.items.length === 0 ? (
            <p className="text-center py-8 text-plum-500">
            ...
            <div className="space-y-2 mb-6">
              {metadata.items.map((item) => (
                ...
                >
                  ...
                  <span className="flex-1 text-plum-900">
                    {item.name}
                  </span>
                </label>
              ))}
                ...
                <div className="ml-7 space-y-3">
                  <div className="space-y-2">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-plum-900">All trustees must confirm</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="radio"
                        ...
                        className="w-4 h-4 text-primary-600 focus:ring-primary-500"
                      />
                      <span className="text-sm text-plum-900">Any single trustee can confirm</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="radio"
                        ...
                        className="w-4 h-4 text-primary-600 focus:ring-primary-500"
                      />
                      <span className="text-sm text-plum-900 flex items-center gap-2">
                        At least
                        <input
                          type="number"
                          ...
                          className="w-16 px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white text-plum-900"
                        />
        ...
        <Card>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-plum-900">{bundleName}</p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {selectedItems.map((itemId) => {
                  ...
                  return item ? (
                    <li key={itemId} className="flex items-center gap-2 text-plum-900">
                      {item.type === 'file' ? (
            ...
            <div>
              ...
              <ul className="space-y-1">
                {trustees.map((trustee) => (
                  <li key={trustee.id} className="text-plum-900">
                    {trustee.name || trustee.email}
                  </li>
                ))}
              </ul>
