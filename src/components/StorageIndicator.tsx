...
export function StorageIndicator({ tier, usedBytes, limitBytes }: StorageIndicatorProps) {
  ...
  const getBarColor = () => {
    if (percentage >= 100) return 'bg-primary-700';
  ...
  return (
    <>
      <Card className="rounded-3xl border border-champagne-300 bg-white shadow-sm">
        ...
        <div className="mt-4 space-y-2">
          <div className="h-2.5 w-full overflow-hidden rounded-full bg-champagne-200">
            <div
        ...
        {percentage >= 80 && percentage < 100 && tier === 'free' && (
          <div className="mt-3 rounded-2xl border border-accent-200 bg-accent-50 px-4 py-3 text-sm text-accent-800">
